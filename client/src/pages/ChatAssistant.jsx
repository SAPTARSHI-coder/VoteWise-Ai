    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 760, width: '100%', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div key={i} style={{
              ...
              <div style={{
                ...
                background: msg.role === 'user'
                  ...
                  : 'linear-gradient(135deg,#3b7fff,#8b5cf6)',
                border: msg.role === 'user' ? '1px solid rgba(255,255,255,0.12)' : 'none',
              }}>
                {msg.role === 'user'
                  ? <User size={15} color="#7f8ea3" />
                  : <BotIcon />
                }
              </div>
              ...
              <div style={{
                ...
                background: msg.role === 'user'
                  ? 'linear-gradient(135deg, #1e40af 0%, #4c1d95 100%)'
                  : 'rgba(22, 27, 39, 0.95)',
                border: msg.role === 'user'
                  ? 'none'
                  : '1px solid rgba(255,255,255,0.08)',
                boxShadow: msg.role === 'user'
                  ? '0 4px 20px rgba(59,127,255,0.2)'
          ...
          {/* Suggested Questions */}
          {showSuggestions && (
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', paddingLeft: '2.75rem' }}>
              {SUGGESTED.map((q, i) => (
      ...
      <div style={{
        ...
        >
          ...
          <button type="submit" disabled={loading || !input.trim()} style={{
            ...
            <Send size={16} color={input.trim() && !loading ? 'white' : '#3d4d63'} />
          </button>
        </form>
        <p style={{ textAlign: 'center', fontSize: '0.72rem', color: '#3d4d63', marginTop: '0.6rem' }}>
